          ...
          <div className="w-full rounded-[16px] py-1 flex items-center justify-between space-x-1">
              ...
              <div className='w-fit pr-2'>
                ...
                <span className='flex items-center w-fit text-[15px]'>
                   ...
                   <span className='font-semibold text-primary'>
                     +{formatNumber(checkinRewards)} {process.env.REACT_APP_PROJECT_SYMBOL}
                   </span>
                 </span>
              ...
              <div className='w-fit pr-2'>
                ...
                <span className='flex items-center w-fit text-[15px]'>
                   ...
                   <span className='font-semibold text-primary'>
                     +{formatNumber(taskPoints)} {process.env.REACT_APP_PROJECT_SYMBOL}
                   </span>
                 </span>
              ...
              <div className='w-fit pr-2'>
                ...
                <span className='flex items-center w-fit text-[15px]'>
                   ...
                   <span className='font-semibold text-primary'>
                     +{formatNumber(miningTotal)} {process.env.REACT_APP_PROJECT_SYMBOL}
                   </span>
                 </span>
              ...
              <div className='w-fit pr-2'>
               ...
               Telegram Premium
                ...
                <span className='flex items-center w-fit text-[15px]'>
                   ...
                   <span className='font-semibold text-primary'>
                     +{formatNumber(premiumReward)} {process.env.REACT_APP_PROJECT_SYMBOL}
                   </span>
                 </span>
