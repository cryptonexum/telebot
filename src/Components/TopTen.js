...
const getInitials = (username) => {
  ...
  const rankImages = [
    ...
    '/10th.webp', // 5th place image
      ...
      const rewards = [
        { rank: 1, amount: '200 TON' },  // 1st place reward
        { rank: 2, amount: '100 TON' },   // 2nd place reward
        { rank: 3, amount: '50 TON' },   // 3rd place reward
        { rank: 4, amount: '30 TON' },   // 4th place reward
        { rank: 5, amount: '10 TON' },    // 5th place reward
      ];
