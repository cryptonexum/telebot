...
// const tasks = [
//   {
//     title: 'Follow Stars Channel',
//     bonus: 4000,
//     chatId: '-1002227548826',
//     icon: '/telegram.svg',
              ...
              <div className={`${
                ...
                <div className="w-full flex justify-center flex-col items-center space-y-3">
                  ...
                  <h3 className="font-medium text-[20px] text-[#ffffff] pt-2 pb-2">
                    <span className={`text-accent`}>+{formatNumberCliam(claimedBonus)}</span> {process.env.REACT_APP_PROJECT_SYMBOL} CLAIMED
                  </h3>
